                        ...
                        <div class="col-md-6">
                            ...
                            <form method="post" name="f" action="j_spring_security_check">
                                ...
                                <div class="form-group">
                                  <label for="j_username">Usuario:</label><input type="text" class="form-control" id="j_username" name="j_username" placeholder="Usuario" value="">
                                </div>
                                <div class="form-group">
                                  <label for="j_password">Clave:</label><input type="password" class="form-control" id="j_password" name="j_password" placeholder="Clave" value="">
                                </div>
